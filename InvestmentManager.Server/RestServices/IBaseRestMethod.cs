...
namespace InvestmentManager.Server.RestServices
{
    ...
    {
        Task<BaseActionResult> BasePostAsync<TEntity, TModel>(ModelStateDictionary modelState, TEntity result, TModel model, Func<TModel, bool> func = null) where TEntity : class where TModel : class;
