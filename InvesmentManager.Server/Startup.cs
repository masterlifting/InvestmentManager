...
using InvestManager.Calculator;
using InvestManager.Calculator.ConfigurationBinding;
using InvestManager.Mapper.Implimentations;
using InvestManager.Mapper.Interfaces;
using InvestManager.PriceFinder.Implimentations;
using InvestManager.PriceFinder.Interfaces;
using InvestManager.ReportFinder.Implimentations;
using InvestManager.ReportFinder.Interfaces;
using InvestManager.Repository;
using InvestManager.Services.Implimentations;
...
namespace InvestManager.Server
{
